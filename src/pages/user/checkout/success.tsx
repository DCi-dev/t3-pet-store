...
const CheckoutSuccess: NextPage<Props> = ({ products }) => {
  ...
  return (
    <main className="relative bg-neutral-800 lg:min-h-full">
          ...
          <div className="lg:col-start-2">
            ...
            <dl className="space-y-6 border-t border-neutral-700 pt-6 text-sm font-medium text-neutral-400">
              <div className="flex justify-between">
                ...
                <dd className="text-neutral-100">$72.00</dd>
              </div>

              <div className="flex justify-between">
                <dt className="text-neutral-100">Shipping</dt>
                <dd className="text-neutral-100">$8.00</dd>
              </div>

              <div className="flex justify-between">
                <dt className="text-neutral-100">Taxes</dt>
                <dd className="text-neutral-100">$6.40</dd>
              </div>
              ...
              <div className="flex items-center justify-between border-t border-neutral-700 pt-6 text-neutral-100">
                ...
                <dd className="text-base text-neutral-200">$86.40</dd>
              </div>
            </dl>
